...
public class CourierController {
    ...
    @GetMapping("/find/{id}")
    public EntityModel<CourierDto> getCourierById(@PathVariable UUID id) {
    ...
    @PutMapping("/edit/{id}")
    public EntityModel<CourierDto> editCourier(@RequestBody CreateCourierDto createCourierDto, @PathVariable UUID id) {
