package com.delivery.mainservice.controllers;
...
public class OrderCourierController {
    ...
    @GetMapping("/find/{id}")
    public EntityModel<OrderCourierDto> getOrderCourierById(@PathVariable UUID id) {
    ...
    public ResponseEntity<Void> deleteOrderCourier(@PathVariable UUID id) {
        orderCourierService.deleteOrderCourier(id);
        return ResponseEntity.noContent().build();
    }

    @PutMapping("/edit/{id}")
    public EntityModel<OrderCourierDto> editOrderCourier(@RequestBody CreateOrderCourierDto createOrderCourierDto, @PathVariable UUID id) {
