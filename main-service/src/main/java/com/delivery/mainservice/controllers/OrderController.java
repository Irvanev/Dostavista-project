...
public class OrderController {
    ...
    @GetMapping("/find/{id}")
    public EntityModel<OrderDto> getOrderById(@PathVariable UUID id) {
    ...
    @PostMapping("/create")
    public EntityModel<OrderDto> createOrder(@RequestBody CreateOrderDto createOrderDto) {
    ...
    @PutMapping("/edit/{id}")
    public EntityModel<OrderDto> editOrder(@RequestBody CreateOrderDto createOrderDto, @PathVariable UUID id) {
